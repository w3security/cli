...
describe('`w3security test` of basic projects for each language/ecosystem', () => {
  let server;
  ...
  test('run `w3security test` on a go project and ensure that required modules are not cached', async () => {
  ...
  test('run `w3security test` on a python project', async () => {
  ...
  test('run `w3security test` on a hex project', async () => {
  ...
  test('run `w3security test` on a composer project', async () => {
  ...
  test('run `w3security test` on a sbt project', async () => {
