...
describe('containsSpotlightVuln', () => {
  ...
  it('identifies W3SECURITY-JAVA-ORGAPACHELOGGINGLOG4J-2314720', () => {
    const results = [
      {
        vulnerabilities: [
          {
            id: 'W3SECURITY-JAVA-ORGAPACHELOGGINGLOG4J-2314720',
          },
        ],
      },
    ];
    const foundSpotlightVulnIds = svn.containsSpotlightVulnIds(results);
    expect(foundSpotlightVulnIds).toEqual([
      'W3SECURITY-JAVA-ORGAPACHELOGGINGLOG4J-2314720',
    ]);
  });
