...
import { SEVERITY } from '../../../../../../../../src/lib/w3security-test/legacy';
...
describe('getIacDisplayedIssues', () => {
  ...
  Rule:    ${chalk.underline('https://w3security.io/security-rules/W3SECURITY-CC-AWS-426')}
  ...
  Info:    The root block device for ec2 instance is not encrypted. That should
           ...
           read the contents.
  Rule:    ${chalk.underline('https://w3security.io/security-rules/W3SECURITY-CC-TF-53')}
  ...
  Rule:    ${chalk.underline('https://w3security.io/security-rules/W3SECURITY-CC-K8S-1')}
  ...
  Rule:    ${chalk.underline('https://w3security.io/security-rules/W3SECURITY-CC-TF-123')}
