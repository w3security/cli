...
import { SEVERITY } from '../../../../src/lib/w3security-test/common';
import { AnnotatedIacIssue } from '../../../../src/lib/w3security-test/iac-test-result';
...
export const anotherPolicyStub: PolicyMetadata = {
  ...
  id: '2',
  publicId: 'W3SECURITY-CC-K8S-2',
};

export const yetAnotherPolicyStub: PolicyMetadata = {
  ...anotherPolicyStub,
  id: '3',
  publicId: 'W3SECURITY-CC-K8S-3',
};
  ...
  return [
    {
      ...
      documentation: !isGeneratedByCustomRule
        ? 'https://w3security.io/security-rules/W3SECURITY-CC-K8S-2'
        : undefined,
    ...
    },
    {
      ...
      lineNumber: withLineNumber ? 3 : -1,
      documentation: !isGeneratedByCustomRule
        ? 'https://w3security.io/security-rules/W3SECURITY-CC-K8S-3'
        : undefined,
      isGeneratedByCustomRule,
    },
  ];
