...
test('test command line arguments', (t) => {
  const cliArgs = [
    ...
    '/Users/dror/work/w3security/w3security-internal/cli',
    'test',
    '--',
    '-Paxis',
    '-Pjaxen',
...
test('when command line "container"', (c) => {
  c.test('set option imageSavePath via config set', (t) => {
    delete process.env['W3SECURITY_IMAGE_SAVE_PATH'];
  ...
  c.test('set option imageSavePath via env var', (t) => {
    process.env['W3SECURITY_IMAGE_SAVE_PATH'] = './my/custom/image/save/path';
    const cliArgs = [
      '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
      '/Users/dror/work/w3security/w3security-internal/cli',
      'container',
...
test('test command line "w3security monitor --project-name-prefix" should add a property on options', (t) => {
  const cliArgs = [
    '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
    '/Users/dror/work/w3security/w3security-internal/cli',
    'monitor',
...
test('test command line "w3security monitor --packages-folder" should add a property on options', (t) => {
  const cliArgs = [
    '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
    '/Users/dror/work/w3security/w3security-internal/cli',
    'monitor',
...
test('test command line "w3security monitor --assets-project-name" should add a property on options', (t) => {
...
test('test command line "w3security iac --experimental" should be true on options', (t) => {
  const cliArgsWithFlag = [
    '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
    '/Users/dror/work/w3security/w3security-internal/cli',
    'iac',
...
test('test command line "w3security iac --experimental --detection-depth=1" should be 1 on options', (t) => {
  const cliArgsWithFlag = [
    '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
    '/Users/dror/work/w3security/w3security-internal/cli',
    'iac',
...
test('test command line "w3security iac test --rules=./path/to/bundle.tar.gz" should have path on options', (t) => {
  const cliArgsWithFlag = [
    '/Users/dror/.nvm/versions/node/v6.9.2/bin/node',
    '/Users/dror/work/w3security/w3security-internal/cli',
    'iac',
