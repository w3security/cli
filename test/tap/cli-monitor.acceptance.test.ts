...
import { w3securityHttpClient } from '../../src/lib/request/w3security-http-client';
...
if (!isWindows) {
  ...
  test('`monitor gradle --prune-repeated-subdependencies`', async (t) => {
    ...
    t.equal(
      ...
      'verify if the generated depGraph from w3security monitor has been pruned',
    );
  });
    ...
    const plugin = {
      async inspect() {
        return {
          plugin: {
            targetFile: 'Podfile',
            name: 'w3security-cocoapods-plugin',
            runtime: 'cocoapods',
          },
          package: {},
        };
