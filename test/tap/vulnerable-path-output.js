...
const w3security = require('..');
const { getFixturePath } = require('../jest/util/getFixturePath');

sinon.stub(w3security, 'test', function () {
  return require(getFixturePath('more-vuln-paths-than-vulns'));
});

tap.tearDown(function () {
  w3security.test.restore();
});

test('"w3security test --show-vulnerable-paths=false"', function (t) {
...
test('"w3security test"', function (t) {
  return cli
