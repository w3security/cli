...
import { LegacyVulnApiResult, TestResult } from '../../../lib/w3security-test/legacy';
...
import { FailOn } from '../../../lib/w3security-test/common';
import {
...
export default async function test(
  ...
  for (const path of paths) {
    ...
    try {
      res = await w3security.test(path, testOpts);
    } catch (error) {
