...
import { SEVERITY } from '../../../../../lib/w3security-test/common';
import {
  AnnotatedIssue,
  IgnoreSettings,
  TestResult,
...
export interface PolicyMetadata {
  ...
  subType: string;
  title: string;
  documentation?: string; // e.g. "https://w3security.io/security-rules/W3SECURITY-CC-K8S-2",
