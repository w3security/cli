...
export class FailedToPullCustomBundleError extends CustomError {
  constructor(message?: string) {
    ...
    this.userMessage =
      ...
      '\nSee documentation on troubleshooting: https://docs.w3security.io/products/w3security-infrastructure-as-code/custom-rules/use-IaC-custom-rules-with-CLI/using-a-remote-custom-rules-bundle#troubleshooting';
  }
}
