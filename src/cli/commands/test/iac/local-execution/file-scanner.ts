...
import { SEVERITIES } from '../../../../../lib/w3security-test/common';
...
export class FailedToBuildPolicyEngine extends CustomError {
  constructor(message?: string) {
    ...
    this.userMessage =
      'We were unable to run the test. Please run the command again with the `-d` flag and contact support@w3security.io with the contents of the output';
  }
}
