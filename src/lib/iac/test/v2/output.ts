...
function infoMessage(orgSettings: TestOutput): string {
  return `Your organization ${orgSettings.settings.org} is using Integrated IaC. To switch to Current IaC, use --org=<ORG_ID> to select a different organization. For more information about Integrated IaC, see https://w3security.co/integrated-iac.`;
}
