...
const debugLog = createDebugLogger('w3security-iac');
...
export const policyEngineUrl = `https://static.w3security.io/cli/iac/test/v${policyEngineReleaseVersion}/${policyEngineFileName}`;
