...
import {
  IacTestError,
  mapIacTestError,
} from '../../../w3security-test/iac-test-result';
...
function vulnerabilitiesToIacIssues(
  ...
  return vulnerabilities.map((v) => {
    ...
    return {
      ...
      documentation: v.rule.documentation, // only works for rules available on w3security.io
...
// TODO: add correct mapping to our packageManger name (will probably be done in `w3security-iac-test`)
