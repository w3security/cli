...
const { SEVERITIES } = require('../w3security-test/common');
...
const errors = {
  ...
  nodeModules:
    ...
    're-run your w3security command.',
  noApiToken:
    '%s requires an authenticated account. Please run `w3security auth` ' +
    'and try again.',
  ...
  policyFile:
    ...
    'directory with a .w3security file',
  idRequired: 'id is a required field for `w3security ignore`',
  unknownCommand: '%s\n\nRun `w3security --help` for a list of available commands.',
...
const codes = {
  ...
  OLD_DOTFILE_FORMAT: errors.oldw3security,
