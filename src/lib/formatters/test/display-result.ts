...
export function displayResult(
  ...
  if (res.ok && res.vulnerabilities.length === 0) {
    ...
    return (
      ...
      (isCI()
        ? ''
        : dockerAdvice + nextStepsText + w3securityPackageTestTip + dockerCTA)
    );
  }
