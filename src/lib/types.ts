...
import { FailOn } from './w3security-test/common';
...
export interface PolicyOptions {
  'ignore-policy'?: boolean; // used in w3security/policy lib
  'trust-policies'?: boolean; // used in w3security/policy lib
  'policy-path'?: string;
  loose?: boolean;
}
...
export enum SupportedCliCommands {
  ...
  about = 'about',
  help = 'help',
  // config = 'config', // TODO: cleanup `$ w3security config` parsing logic before adding it here
