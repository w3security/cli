...
$(BINARY_RELEASES_FOLDER_TS_CLI)/w3security.tgz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI) 
	$(MAKE) pack-binary-wrapper
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security.tgz.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-fix.tgz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	mv $(shell npm pack --workspace '@snyk/fix') $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-fix.tgz
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-fix.tgz.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-protect.tgz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	mv $(shell npm pack --workspace '@w3security/protect') $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-protect.tgz
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-protect.tgz.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-alpine: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node16-alpine-x64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-alpine
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-alpine.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-linux: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node16-linux-x64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-linux
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-linux.sha256
...
$(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-linux-arm64: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node16-linux-arm64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-linux-arm64 --no-bytecode
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-linux-arm64.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-macos: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node16-macos-x64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-macos
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-macos.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-win.exe: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	$(PKG) -t node16-win-x64 -o $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-win.exe
	./cliv2/scripts/sign_windows.sh $(BINARY_RELEASES_FOLDER_TS_CLI) w3security-win.exe
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-win.exe.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-for-docker-desktop-darwin-x64.tar.gz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	./docker-desktop/build.sh darwin x64
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-for-docker-desktop-darwin-x64.tar.gz.sha256

$(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-for-docker-desktop-darwin-arm64.tar.gz: prepack | $(BINARY_RELEASES_FOLDER_TS_CLI)
	./docker-desktop/build.sh darwin arm64
	$(MAKE) $(BINARY_RELEASES_FOLDER_TS_CLI)/w3security-for-docker-desktop-darwin-arm64.tar.gz.sha256
...
pack-binary-wrapper: build-binary-wrapper
	@echo "-- Packaging tarball ($(BINARY_OUTPUT_FOLDER)/w3security.tgz)"
